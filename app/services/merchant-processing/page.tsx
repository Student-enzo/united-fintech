      ...
      <section className="uf-section-navy" style={{ padding: '9rem 1.5rem 6rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="max-w-4xl mx-auto relative" style={{ zIndex: 1, textAlign: 'center' }}>
          <div style={{
            ...
            <CreditCard size={14} color="#1EA8D4" strokeWidth={2} />
            <span style={{ color: '#1EA8D4', fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase' }}>Merchant Processing</span>
          </div>
          <h1 style={{
