    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#141C28] text-sm text-white/40">
            No image
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        <div className="text-xl font-semibold text-white tracking-wide" style={{ fontFamily: 'var(--font-heading)', letterSpacing: '0.05em' }}>
          {item.title}
        </div>
        {item.description ? (
