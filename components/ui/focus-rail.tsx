          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                ...
                transition={{ ...BASE_SPRING, scale: TAP_SPRING } as any}
          ...
          <div className="flex items-center gap-4">
            ...
            {activeItem.href && (
              <Link
                ...
                className="group/btn flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-black transition-transform hover:scale-105 active:scale-95"
              >
                Explore
