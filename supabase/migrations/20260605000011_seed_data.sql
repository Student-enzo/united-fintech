...
INSERT INTO merchants (
  ...
  ('20000000-0000-0000-0000-000000000001', 'Suncoast Retail Group',       'Suncoast Shops',    '5411', 'Grocery Stores',                     'llc',             'card_present', 38500000,  6200,  94, 'merchant_live',     '10000000-0000-0000-0000-000000000001', 'Marcus Webb',   'low'),
  ('20000000-0000-0000-0000-000000000002', 'BluePeak eCommerce LLC',      'BluePeak Store',    '5999', 'Retail Stores, NEC',                 'llc',             'ecommerce',    21000000, 12800,   0, 'account_activated', '10000000-0000-0000-0000-000000000002', 'Priya Nair',    'low'),
  ('20000000-0000-0000-0000-000000000003', 'Atlas Medical Supplies',      NULL,                '5047', 'Medical & Hospital Equipment',       'corporation',     'moto',          9500000, 31000,  10, 'underwriting',      '10000000-0000-0000-0000-000000000003', 'Jordan Reyes',  'medium'),
  ('20000000-0000-0000-0000-000000000004', 'NovaBrew Coffee Co.',         'NovaBrew',          '5812', 'Eating Places & Restaurants',        's_corp',          'card_present',  5200000,  1800,  98, 'setup_fee_paid',    '10000000-0000-0000-0000-000000000001', 'Marcus Webb',   'low'),
  ('20000000-0000-0000-0000-000000000005', 'PrimeAuto Finance',           NULL,                '5511', 'Auto Dealers - New & Used',          'llc',             'card_present', 72000000,420000,  75, 'agreement_signed',  '10000000-0000-0000-0000-000000000007', 'Derek Huang',   'medium'),
  ('20000000-0000-0000-0000-000000000006', 'ClearView Law Group',         NULL,                '8111', 'Legal Services',                     'partnership',     'moto',          6800000, 85000,   5, 'agreement_sent',    '10000000-0000-0000-0000-000000000002', 'Priya Nair',    'low'),
  ('20000000-0000-0000-0000-000000000007', 'Apex Fitness Studios',        'Apex Fit',          '7997', 'Membership Sports & Recreation Clubs','llc',            'card_present',  4100000,  5500,  88, 'proposal_sent',     '10000000-0000-0000-0000-000000000001', 'Leila Hassan',  'low'),
  ('20000000-0000-0000-0000-000000000008', 'OceanTech Imports',           NULL,                '5065', 'Electrical Parts & Equipment',       'corporation',     'ecommerce',    15500000, 24000,   0, 'lead_identified',   '10000000-0000-0000-0000-000000000007', 'Derek Huang',   'medium'),
  ('20000000-0000-0000-0000-000000000009', 'Harborside Hospitality',      'Harborside Hotels', '7011', 'Hotels & Motels',                    'llc',             'card_present', 49000000, 19500,  82, 'merchant_live',     '10000000-0000-0000-0000-000000000002', 'Sofia Andrade', 'low'),
  ('20000000-0000-0000-0000-000000000010', 'RedLine Logistics Inc.',      NULL,                '4215', 'Courier Services',                   'corporation',     'ach',          32000000,110000,   0, 'underwriting',      '10000000-0000-0000-0000-000000000003', 'Sofia Andrade', 'medium'),
  ('20000000-0000-0000-0000-000000000011', 'StarPath Education',          'StarPath Online',   '8299', 'Schools & Educational Services',     's_corp',          'ecommerce',     7800000, 29900,   0, 'proposal_sent',     '10000000-0000-0000-0000-000000000001', 'Jordan Reyes',  'low'),
  ('20000000-0000-0000-0000-000000000012', 'TerraVerde Cannabis Dist.',   'TerraVerde',        '5912', 'Drug Stores & Pharmacies',           'llc',             'card_present', 16500000,  7200,  95, 'declined',          '10000000-0000-0000-0000-000000000007', 'Marcus Webb',   'high')
ON CONFLICT (id) DO NOTHING;
